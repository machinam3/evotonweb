		...
		<main class="animsition-overlay" data-animsition-overlay="true">
			...
			<section id="up" class="page-head flex-min-height-box dark-bg-2">
				<!-- page-head-bg -->
				<div class="page-head-bg overlay-loading2" style="background-image: url(<?php echo base_url('asset/images/backgrounds/adolescent-adult-diversity-1034361.jpg'); ?>);"></div>
		  			...
		  			<div class="container top-bottom-padding-120 flex-container response-999">
			  			...
			  			<div class="six-columns six-offset">
				  			<div class="content-left-margin-40">
					  			<h2 class="overlay-loading2 tr-delay03 medium-title red-color">Welcome Evoton</h2>
				...
				<div class="flex-container container bottom-padding-60 top-padding-120">
					...
					<div class="four-columns bottom-padding-60">
						<a data-animation-container href="#" class="content-left-right-margin-10 hover-box pointer-large d-block">
							<div data-animation-child class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
								<img class="hover-img" src="<?php echo base_url('asset/images/team/1.jpg'); ?>" alt="Balanchaev Balancha">
							</div>
					...
					<div class="four-columns bottom-padding-60">
						<a data-animation-container href="#" class="content-left-margin-20 hover-box pointer-large d-block">
							<div data-animation-child class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
								<img class="hover-img" src="<?php echo base_url('asset/images/team/2.jpg'); ?>" alt="Balanchaev Balancha">
							</div>
							<div class="team-content">
					...
					<div class="four-columns bottom-padding-60">
						<a data-animation-container href="#" class="content-right-margin-20 hover-box pointer-large d-block">
							<div data-animation-child class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
								<img class="hover-img" src="<?php echo base_url('asset/images/team/3.jpg'); ?>" alt="Balanchaev Balancha">
							</div>
							<div class="team-content">
					...
					<div class="four-columns bottom-padding-60">
						<a data-animation-container href="#" class="content-left-right-margin-10 hover-box pointer-large d-block">
							<div data-animation-child class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
								<img class="hover-img" src="<?php echo base_url('asset/images/team/4.jpg'); ?>" alt="Balanchaev Balancha">
							</div>
							<div class="team-content">
					...
					<div class="four-columns bottom-padding-60">
						<a data-animation-container href="#" class="content-left-margin-20 hover-box pointer-large d-block">
							<div data-animation-child class="overlay-anim-box2 overlay-dark-bg-1 team-img-box" data-animation="overlay-anim2">
								<img class="hover-img" src="<?php echo base_url('asset/images/team/5.jpg'); ?>" alt="Balanchaev Balancha">
							</div>
							<div class="team-content">
				...
				<div class="about-slider bottom-padding-60">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<img src="<?php echo base_url('asset/images/about/adult-brainstorming-business-1437908.jpg'); ?>" alt="about">
						</div>
						<div class="swiper-slide">
							<img src="<?php echo base_url('asset/images/about/apple-computer-desk-159807.jpg'); ?>" alt="about">
						</div>
						<div class="swiper-slide">
							<img src="<?php echo base_url('asset/images/about/apple-brainstorming-business-908288.jpg'); ?>" alt="about">
						</div>
						<div class="swiper-slide">
							<img src="<?php echo base_url('asset/images/about/adult-bear-beautiful-792535.jpg'); ?>" alt="about">
						</div>
						<div class="swiper-slide">
							<img src="<?php echo base_url('asset/images/about/hands-indoors-man-1204001.jpg'); ?>" alt="about">
						</div>
