		...
		<main class="animsition-overlay" data-animsition-overlay="true">
				...
				<!-- swiper-wrapper start -->
			  	<div class="swiper-wrapper">
				  	...
				  	<div class="swiper-slide flex-min-height-box home-slide">
					  	<!-- slide-bg -->
				      	<div class="slide-bg overlay-loading2 overlay-dark-bg-1" style="background-image:url(<?php echo base_url('asset/images/backgrounds/pexels-photo-1806031.jpg'); ?>)"></div>
						      	...
						      	<div class="six-columns six-offset">
							      	<div class="content-left-margin-40">
								      	<h2 class="large-title-bold">
							  				...
							  				<span class="slider-title-fill slider-tr-delay03" data-text="novative ideas">novative ideas</span>
						  				</h2>
						  				<p class="p-style-bold-up text-height-20 d-flex-wrap">
										  	<span class="slider-title-fill slider-tr-delay04" data-text="Software">Software</span>
										  	<span class="slider-title-fill slider-tr-delay05" data-text="Development">Development</span>
										  	<span class="slider-title-fill slider-tr-delay06" data-text="Done Right">Done Right</span>
									  	</p>
				    ...
				    <div class="swiper-slide flex-min-height-box home-slide">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image:url(<?php echo base_url('asset/images/backgrounds/daniel-korpai-8GDCzWrcE3M-unsplash.jpg'); ?>)"></div>
				      	<!-- home-slider-content start -->
					  	<div class="home-slider-content flex-min-height-inner dark-bg-2">
					      	...
					      	<div class="container top-bottom-padding-120 flex-container response-999">
						      	...
						      	<div class="six-columns six-offset">
							      	<div class="content-left-margin-40">
								      	<h2 class="slider-overlay2 medium-title red-color">Welcome to EVOTON</h2>
				    ...
				    <div class="swiper-slide flex-min-height-box home-slide red-slide">
					    <!-- slide-bg -->
				      	<div class="slide-bg" style="background-image:url(<?php echo base_url('asset/images/backgrounds/marvin-meyer-SYTO3xs06fU-unsplash.jpg'); ?>)"></div>
				      	<!-- home-slider-content start -->
					  	<div class="home-slider-content flex-min-height-inner red-bg">
					      	...
					      	<div class="container top-bottom-padding-120 flex-container response-999">
						      	...
						      	<div class="six-columns">
							      	<h2 class="large-title-bold">
						  				<span class="slider-title-fill slider-tr-delay01" data-text="We Provide">We Provide</span><br>
						...
						<div data-animation-container class="flex-container">
							...
							<div class="twelve-columns text-center">
								<h2 class="large-title text-height-12">
									...
									<span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="We are EVOTON">We are Evoton</span>
								</h2>
							</div><!-- column end -->
							<!-- column start -->
							<div class="six-columns">
							...
							<div class="flex-container container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(<?php echo base_url('asset/images/projects/pexels-photo-1619654.jpg'); ?>)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(<?php echo base_url('asset/images/projects/audio-cassette-cassette-tape-1626481.jpg'); ?>)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(<?php echo base_url('asset/images/projects/blur-close-up-equipment-1034651.jpg'); ?>)"></div>
									</a>
								</div><!-- column end -->
							</div><!-- flex-container end -->
						</div><!-- portfolio-content-inner end -->
					...
					<div class="portfolio-content flex-min-height-box">
						...
						<div class="portfolio-content-inner flex-min-height-inner">
							...
							<div class="flex-container reverse container small">
								...
								<div class="six-columns top-padding-60">
									<a href="project.html" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
										<div class="portfolio-content-bg hover-img overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2" style="background-image:url(<?php echo base_url('asset/images/projects/chocolate-delicious-dessert-890500.jpg'); ?>)"></div>
									</a>
								</div><!-- column end -->
								<!-- column start -->
								<div data-animation-container class="six-columns">
					...
					<ul class="client-list d-flex-wrap top-padding-60">
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/3eabc7ab-8bae-44f0-8389-0169389e38c2.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/1c4bfb0e-0b9f-4c19-ba5c-113fb0714514.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/6b9fcb90-c595-432a-a97c-fcd318b74c04.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/699301b6-83ff-47f8-ad46-a6b871e79293.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/7d1fe64f-fbd7-4e5f-896d-6d79c91f29bf.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/858e2e28-faae-441c-bd9c-5c490c72b562.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/8b587214-bdcb-4d74-bb61-2480d1d15aa7.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/4b983c9a-759d-4921-ba60-dbbcaa702ee5.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/8f65e211-cd41-46dc-8c1d-ba228ac36eb9.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/9c30d6d6-6af9-4fb1-bed3-e5ea4df4c281.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/4731da4b-b2fb-4c10-aee7-c89484a5d473.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/69cb9e61-d0b8-4420-b8bd-454c9b9e1dc1.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/492492b2-b7d9-4648-a164-f530ecd6321a.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/9a6c570f-d03a-4806-9a30-dddc648707d9.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/b908b85c-f837-4dba-80cf-d961d6fcad29.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/6e63c653-6997-42c6-b788-28e9fb6d15b7.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/d5f831cf-3fb0-490b-aadc-3591c8b64156.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/2ed0436b-e3ea-48aa-85ca-755de0719c9a.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/d51e13e6-1320-4227-8bc8-c36aaa82dffd.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/aed14647-8ecf-4fef-8274-737d79a7ede1.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
						<li>
							<a href="#" class="pointer-large d-block">
								<div class="brand-box">
									<img src="<?php echo base_url('asset/images/clients/d383cf8d-abee-4290-810d-a965f6c0fa6c.png'); ?>" alt="Brand" class="hover-opac-img">
									<img src="<?php echo base_url('asset/images/clients/7f7b6ede-3a3e-4e17-af25-f881c0121d63.png'); ?>" alt="Brand" class="opac-img">
								</div>
							</a>
						</li>
				...
				<div class="testimonials-slider container small">
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide text-center">
							<img src="<?php echo base_url('asset/images/testimonials/adult-beanie-black-background-1529350.jpg'); ?>" alt="author">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="<?php echo base_url('asset/images/testimonials/pexels-photo-428340.jpg'); ?>" alt="author">
							<div class="testimonials-content">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="<?php echo base_url('asset/images/testimonials/pexels-photo-764529.jpg'); ?>" alt="author">
							<div class="testimonials-content">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="<?php echo base_url('asset/images/testimonials/pexels-photo-809433.jpg'); ?>" alt="author">
							<div class="testimonials-content">
						...
						<!-- slide start -->
						<div class="swiper-slide text-center">
							<img src="<?php echo base_url('asset/images/testimonials/pexels-photo-894156.jpg'); ?>" alt="author">
							<div class="testimonials-content">
			...
			<div class="video-content-bg" style="background-image:url(<?php echo base_url('asset/images/backgrounds/business-calligraphy-chinese-lanterns-1455969.jpg'); ?>)">
					...
					<div class="flex-container response-999 top-padding-60">
							...
							<article class="content-right-margin-20 light-bg-2" data-animation-container>
								<a href="single_post.html" class="pointer-large animsition-link hover-box d-block">
									<div class="overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2">
										<img class="hover-img" src="<?php echo base_url('asset/images/blog/bodypaint-female-girl-50595.jpg'); ?>" alt="blog img">
									</div>
						...
						<div class="four-columns bottom-padding-90">
							<article class="content-left-right-margin-10 light-bg-2" data-animation-container>
								<a href="single_post.html" class="pointer-large animsition-link hover-box d-block">
									<div class="overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2">
										<img class="hover-img" src="<?php echo base_url('asset/images/blog/auto-automobile-automotive-358201.jpg'); ?>" alt="blog img">
									</div>
									<h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
						...
						<div class="four-columns bottom-padding-90">
							<article class="content-left-margin-20 light-bg-2" data-animation-container>
								<a href="single_post.html" class="pointer-large animsition-link hover-box d-block">
									<div class="overlay-anim-box2 overlay-dark-bg-2" data-animation="overlay-anim2">
										<img class="hover-img" src="<?php echo base_url('asset/images/blog/art-blur-close-up-1826029.jpg'); ?>" alt="blog img">
									</div>
									<h3 class="title-style text-color-1 top-margin-30 blog-title content-padding-l-r-20">
